...
exports.handler = async (event) => {
  ...
  try {
    ...
    const buying = new StellarSdk.Asset(code, issuerKP.publicKey()); // DONATEWAY
    const selling = StellarSdk.Asset.native(); // PI
    ...
    const tx = new StellarSdk.TransactionBuilder(acc, {
      ...
      .addOperation(
        StellarSdk.Operation.manageBuyOffer({
          buying,
          selling,
          buyAmount: String(amount), // amount of token to buy
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        buying: { code, issuer: issuerKP.publicKey() },
        selling: "PI",
